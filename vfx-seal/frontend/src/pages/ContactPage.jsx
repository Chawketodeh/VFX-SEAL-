                ...
                <nav className="navbar" id="contact-navbar">
                    <div className="navbar-inner">
                        ...
                        <div className="navbar-actions-public">
                            <Link to="/register" className="btn btn-primary btn-sm">Join the Club</Link>
            ...
            <div className="page-wrapper">
                <div className="container">
                    ...
                    <div className="contact-header slide-up">
                        ...
                        <p>Have a question or want to learn more about VFX Seal? We'd love to hear from you.</p>
                    </div>
                        ...
                        <div className="contact-info-column">
                            <div className="contact-info-card">
                                ...
                                <div>
                                    ...
                                    <a href="https://maps.google.com/maps?q=1601+N+Broadway+Los+Angeles"
                                        target="_blank" rel="noopener noreferrer" className="contact-map-link">
                                        View on Map →
                                    </a>
                                </div>
                            </div>
                            ...
                            <div className="contact-info-card">
                                ...
                                <div>
                                    ...
                                    <a href="https://maps.google.com/maps?q=4433+Chambord+Montreal"
                                        target="_blank" rel="noopener noreferrer" className="contact-map-link">
                                        View on Map →
                                    </a>
                                </div>
                            ...
                            <div className="contact-info-card">
                                ...
                                <div>
                                    <h3>Email Us</h3>
                                    <p><a href="mailto:info@vfx-seal.com">info@vfx-seal.com</a></p>
                                    <p><a href="mailto:contact@vfx-seal.com">contact@vfx-seal.com</a></p>
                                    <a href="mailto:info@vfx-seal.com" className="contact-map-link">
                                        Send Email →
                                    </a>
                                </div>
                            </div>
                        ...
                        <div className="contact-form-card">
                            ...
                            {success ? (
                                ...
                                <form onSubmit={handleSubmit} id="contact-form">
                                    ...
                                    <button type="submit" className="btn btn-primary btn-lg contact-submit-btn" disabled={loading} id="contact-submit">
